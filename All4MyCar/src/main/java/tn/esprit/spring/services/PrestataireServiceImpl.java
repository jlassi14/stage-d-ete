...
public class PrestataireServiceImpl implements PrestataireService {
	...
	@Override
	public Prestataire add_prestataire(Prestataire pres) {
		Prestataire prestataire =   prestatairerepository.save(pres);
		
		return prestataire;
	}

	@Override
	public Void RemovePrestataire(Long idpres) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Prestataire edit_prestataire(Prestataire pres1, Prestataire pres) {
...
return "profil modifie";
	...
	/*@Override
	public Stage saveStage(Stage stage, Long id) {
		Etudiant optionalEtudiant = etudiantRepository.findById(id).get();
		stage.setEtudiant(optionalEtudiant);
		Stage stages = stageRepository.save(stage);
		return stages;
	}*/
	/*@Override
